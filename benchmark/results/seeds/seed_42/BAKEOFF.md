...
Seed 42, test_frac 0.25, bootstrap 2000, methods: equal_weight, s3_weighted, differential_mmfp, pharm2d, shape_combo_rdkit, rdshape_ensemble, learned_scorer, prism, prism_fixed, prism_esp.  Primary metric **BEDROC(α=20)**; Δ vs **s3_weighted** with bootstrap 95% CI.

## ccr2_project  ·  decoy-bias gate: **unbiased**

| method | BEDROC [95% CI] | AUC | EF1% | ΔBEDROC vs s3 [95% CI] |
|--------|-----------------|-----|------|------------------------|
| prism | 0.972 [0.902,1.000] | 0.993 | 7.68 | +0.184 [+0.017,+0.430] |
| prism_esp | 0.971 [0.906,1.000] | 0.993 | 7.68 | +0.184 [+0.017,+0.427] |
| differential_mmfp | 0.971 [0.895,1.000] | 0.981 | 7.68 | +0.180 [+0.021,+0.421] |
| prism_fixed | 0.874 [0.674,0.995] | 0.981 | 7.68 | +0.096 [-0.186,+0.362] |
...
| prism_esp | 0.311 [0.114,0.511] | 0.647 | 10.12 | +0.134 [-0.130,+0.372] |
| prism | 0.293 [0.114,0.492] | 0.645 | 10.12 | +0.114 [-0.129,+0.353] |
| s3_weighted | 0.175 [0.032,0.351] | 0.726 | 10.12 | — (baseline) |
| learned_scorer | 0.133 [0.007,0.286] | 0.651 | 0.00 | -0.040 [-0.232,+0.159] |
| prism_fixed | 0.109 [0.010,0.236] | 0.589 | 0.00 | -0.064 [-0.238,+0.105] |
...
| prism_esp | 0.957 [0.931,0.973] | 0.900 | 3.69 | +0.542 [+0.448,+0.630] |
| prism | 0.952 [0.924,0.970] | 0.901 | 3.69 | +0.537 [+0.443,+0.624] |
| prism_fixed | 0.928 [0.890,0.955] | 0.858 | 3.69 | +0.513 [+0.415,+0.605] |
...
Friedman χ²=23.364, p=0.005; Nemenyi CD=7.822 over N=3 datasets, k=10 methods.
